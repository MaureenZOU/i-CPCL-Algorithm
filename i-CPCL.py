...
def updateCooperative(McObject, MuObject, XtObject, p1, p2, edgeMatrix):
    ...
    l = 0.001 + 0.000001 * np.absolute(edgeMatrix[p1][p2])
    #print(l)
    #l = 0.001
...
fileName = "./animation/i-CPCL_Animation_s2.csv"
...
fileName = "./center/i-CPCL_center_s2.csv"
...
fileName = "./epoch/i-CPCL_RMSE_s2_"+str(seedNum)+".csv"
writeFile(RMSE, fileName)

fileName = "./cpu/i-CPCL_RMSE_s2_"+str(seedNum)+".csv"
...
line = "i-CPCL_RMSE_s2_"+str(seedNum)+": "+ str(distance/(len(seedPoints)*d))+"\n"
fileName = "result.log"
